...
describe('favorite blog', () => {
  ...
  test('of one blog', () => {
    ...
    assert.deepStrictEqual(listHelper.favoriteBlog([blog]), expected)
  })
...
describe('most blogs', () => {
  ...
  test('one blog', () => {
    ...
    assert.deepStrictEqual(listHelper.mostBlogs([blog]), expected)
  })
...
describe('most likes', () => {
  ...
  test('one blog', () => {
    ...
    assert.deepStrictEqual(listHelper.mostLikes([blog]), expected)
  })
